...
class SignUpThirdPage extends StatefulWidget {
  ...
  const SignUpThirdPage({Key? key, required this.userName, required this.userAge, required this.bedTime, required this.goodSleepTime, required this.caffeineHalfLife, required this.userEmail, required this.userPassword}) : super(key: key);
